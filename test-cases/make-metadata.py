...
def main(spec: str):
    with open ('metadata.csv', 'w') as csvfile:
        ...
        for testcase in glob.glob('RML*'):
            ...
            # Input file
            if os.path.exists(os.path.join(testcase, 'data.csv')):
                input1 = 'data.csv'
                input_format1 = 'text/csv'
            elif os.path.exists(os.path.join(testcase, 'data1.csv')):
                input1 = 'data1.csv'
                input_format1 = 'text/csv'

            if os.path.exists(os.path.join(testcase, 'data2.csv')):
                input2 = 'data2.csv'
            ...
            # Output files
            if os.path.exists(os.path.join(testcase, 'output.nt')):
                output1 = 'output.nt'
                output_format1 = 'application/n-triples'
            else:
                error = 'true'
